...
let ParameterViewerComponent = class ParameterViewerComponent extends __WEBPACK_IMPORTED_MODULE_2__base_classes_viz_Viewer__["a" /* Viewer */] {
    ...
    getDataFromURL($event, input) {
        let urlString = 'https://' + input.getOpts().url;
